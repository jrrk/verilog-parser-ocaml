...
val unhand_list : (int * Other.token) list ref
val implicit_params : string list ref
val implicit_wires : string list ref
val unhandled_dflt : Setup.fmt -> int -> Other.token -> unit
val unhandled_ptr : uptr ref
val unhandled : Setup.fmt -> int -> Other.token -> unit
...
val tsymbols : (string, Other.token) Hashtbl.t
...
val stk : (int * Other.token) Stack.t
