...
| QUINTUPLE(MODULE,[ID arg1],arg2,arg3,arg4) ->
    ...
    iter (fun arg -> match arg with ID id -> enter_sym syms id IOPORT | _ -> unhandled arg) arg3;
    iter_ semantics syms arg4
| QUINTUPLE((INPUT|OUTPUT|INOUT|REG) as dir,arg1,arg2,arg3,arg4) ->
    iter_ semantics syms arg1;
    iter_ semantics syms arg2;
    (match arg3 with [RANGE([INTNUM hi],[INTNUM lo]) as rangehilo] -> range hi lo
    ...
    ( match arg4 with [DOUBLE(ID id,arg5)] ->
      ...
      | _ ->  List.iter (fun x -> match x with TRIPLE(ID id,arg5,arg6) -> enter_sym syms id dir | _ -> unhandled x) arg4);
